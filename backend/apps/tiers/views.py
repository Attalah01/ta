    ...
    def post(self, request, format=None):
        ...
        payload = {
            ...
            "auto_recurring": {
                ...
                ),  # Indicates the value of the frequency. 7 days, 1 month
                "frequency_type": request.data.get("frequency_type"),  # days, months
                # "repetitions": 12, # used to create a limited subscription
                "billing_day": 5,
